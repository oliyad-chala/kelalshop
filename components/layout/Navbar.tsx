...
export function Navbar({ user }: NavbarProps) {
  ...
  const isPortalUser = user?.role === 'admin' || user?.role === 'staff'
        ...
        <div className="h-16 sm:h-20 flex items-center justify-between gap-3 lg:gap-8">
          ...
          <div className="hidden sm:flex flex-1 max-w-3xl justify-center">
            ...
            >
              ...
              <button
                type="submit"
                className="bg-amber-500 hover:bg-amber-400 text-navy-950 px-5 transition-colors flex items-center justify-center rounded-r-full"
              >
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <>
                    ...
                    <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-slate-100 py-2 z-50 overflow-hidden fade-in">
                      ...
                      <div className="p-2 space-y-1">
                        <Link
                          href={isPortalUser ? '/admin/dashboard' : '/dashboard'}
                          onClick={() => setUserMenuOpen(false)}
                        ...
                        >
                          ...
                          {isPortalUser ? 'Admin Dashboard' : 'Dashboard'}
                        </Link>
                        {!isPortalUser && (
                          <Link
